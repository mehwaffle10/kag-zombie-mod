// Waffle: Remove unecessary scripts
// #include "Hitters.as";
...
// Waffle: Adapted from TFlippy_TerritoryControl_Core_v130
...
void onTick(CBlob@ this)
{
	...
	// Waffle: Remove effect on vehicles
	/*
	CBlob@[] vehicles;
	...
	*/
	...
	if (isServer())
	{
		// Waffle: Remove random lightning strikes
		/*
		CMap@ map = getMap();
...
// Waffle: Don't need to cleanse anything
/*
...
void DecayStuff()
{
	...
	// Waffle: Plants aren't grown by rain, they grow daily
	/*
	CBlob@[] plants;
